...
const validationSchema1 = Yup.object().shape({
    customer: Yup.string().required('Please select at least one customer!'),
    bookedByPassengerName: Yup.string().required(
    ...
    vehicle: Yup.string().required('Please select at least one vehicle!'),
